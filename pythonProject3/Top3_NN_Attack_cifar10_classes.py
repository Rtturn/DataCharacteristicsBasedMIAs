...
def evaluate(x_test, y_test):
    ...
    for k in range(10):
        ...
        member_=sum(y_test[index:index+1800])
        ...
        nonmember_ratio.append(nonmember_in_m/(1800-sum(y_test[index:index+1800])))
    ...
    result.to_excel('Top3_NN_Attack_classes_cifar10.xlsx')
