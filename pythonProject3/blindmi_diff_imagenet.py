...
(x_train, y_train), (x_test, y_test), m_true = globals()['load_' + DATA_NAME]("TargetModel")
...
def diff_Mem_attack(x_, y_true, m_true, target_model, non_Mem_Generator=sobel):
    ...
    writer=pd.ExcelWriter('result_of_imagenet_one.xlsx')
...
m_true, m_pred, mix, nonMem = diff_Mem_attack(np.r_[x_train,x_test],np.r_[y_train,y_test],m_true,Target_Model)
