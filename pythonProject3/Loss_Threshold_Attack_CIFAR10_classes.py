...
for k in range(10):
    ...
    member_ = sum(m_true[index:index + 1800])
    ...
    nonmember_ratio.append(nonmember_in_m / (1800 - sum(m_true[index:index + 1800])))
result = np.c_[
...
result.to_excel('Loss_Threshold_Attack_cifar10_classes.xlsx')
